 ...
 */
bool is_day_of_sun(void) { return (date_get_dayofyear() + 1) % 2 == 0; }

/*
 * Is today a day of the Moon for Star Gladiators?
 */
bool is_day_of_moon(void) { return (date_get_dayofyear() + 1) % 2 == 1; }

/*
 * Is today a day of the Star for Star Gladiators?
 */
bool is_day_of_star(void) { return (date_get_dayofyear() + 1) % 5 == 0; }
