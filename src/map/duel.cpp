 ...
 */
size_t duel_counttotal() { return duel_list.size(); }
...
void duel_savetime(struct map_session_data* sd) {
	...
	pc_setglobalreg(sd, add_str("PC_LAST_DUEL_TIME"),
...
bool duel_checktime(struct map_session_data* sd) {
	...
	diff = t->tm_mday * 24 * 60 + t->tm_hour * 60 + t->tm_min -
		   pc_readglobalreg(sd, add_str("PC_LAST_DUEL_TIME"));
 ...
 */
bool duel_invite(const size_t did, struct map_session_data* sd,
 ...
 */
void do_final_duel(void) { duel_list.clear(); }

/*
 * Initialisator of duel module
 */
void do_init_duel(void) { duel_list.clear(); }
