...
#define check_distance_bl(bl1, bl2, distance) \
	check_distance((bl1)->x - (bl2)->x, (bl1)->y - (bl2)->y, distance)
#define check_distance_blxy(bl, x1, y1, distance) \
	check_distance((bl)->x - (x1), (bl)->y - (y1), distance)
#define check_distance_xy(x0, y0, x1, y1, distance) \
	check_distance((x0) - (x1), (y0) - (y1), distance)
...
#define check_distance_client_blxy(bl, x1, y1, distance) \
	check_distance_client((bl)->x - (x1), (bl)->y - (y1), distance)
#define check_distance_client_xy(x0, y0, x1, y1, distance) \
	check_distance_client((x0) - (x1), (y0) - (y1), distance)
