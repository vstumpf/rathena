...
t_tick gettick(void) { return (--gettick_count == 0) ? gettick_nocache() : gettick_cache; }
//////////////////////////////
#else
//////////////////////////////
// tick doesn't get cached
t_tick gettick_nocache(void) { return tick(); }

t_tick gettick(void) { return tick(); }
//////////////////////////////////////////////////////////////////////////
#endif
//////////////////////////////////////////////////////////////////////////
	...
	while (BHEAP_LENGTH(timer_heap)) {
		...
		if (timer_data[tid].func) {
			if (diff < -1000)
				...
				timer_data[tid].func(tid, timer_data[tid].tick, timer_data[tid].id,
									 timer_data[tid].data);
		}
...
unsigned long get_uptime(void) { return (unsigned long)difftime(time(NULL), start_time); }
