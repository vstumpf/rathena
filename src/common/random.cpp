...
int32 rnd(void) { return int31_distribution(generator); }

/// Generates a random number in the interval [0, UINT32_MAX]
uint32 rnd_uint32(void) { return uint32_distribution(generator); }
...
bool rnd_chance(uint16 chance, uint16 base) { return rnd_value(0, base) < chance; }
